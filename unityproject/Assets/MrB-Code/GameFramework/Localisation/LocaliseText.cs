...
namespace Assets.GameFramework.Localisation
{
    ...
    {
        private class LocalisationChangedMessage
        {
            public LocalisationChangedMessage(string language, string oldLanguage)
            {
        ...
        private static class GameManager
        {
            ...
            public static T LoadResource<T>(string localisation)
            {
                throw new NotImplementedException();
            }
        }
        ...
        public static string Get(string key, string language = null)
        {
            ...
            Debug.LogWarning(string.Format("Localisation key not found: '{0}' for Language {1}", key, Language));
